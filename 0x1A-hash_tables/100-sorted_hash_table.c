...
/**
 * make_shash_node - the sorted hash table
...
/**
 * add_to_sorted_list - appends a node to the sorted
...
/**
 * shash_table_set - assignvalue in the hash table
 * @ht: sorted hash table
 * @key: ...
 * @value: information
 * Return: suucess always
 */
...
/**
 * shash_table_print - outputs a sorted hash table
 * @ht: hash table
 * Return: nothing
 */
...
/**
 * shash_table_print_rev - output a sorted hash table in reverse
 * @ht: hash table
 * Return: nothing
 */
